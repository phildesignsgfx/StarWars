...
const PlanetView = () => {
    ...
    const getPlanetDataFromLocalStorage = () => {
    ...
    planets = getPlanetDataFromLocalStorage();
    return (
        <>
            {planets.map(planet => {
                return id === planet.result._id ? (
                    <div key={planet.result.uid} className="container-fluid bg-dark min-vh-100 py-1">
                        <div className="row">
                            <div className="col-6">
                                <img
